            ...
            <form action="products.php" method="POST">
                ...
                <div class="input-group mb-3 form-group">
                    ...
                    <select name="cat" class="form-select" id="inputGroupSelect01">
                        ...
                        <option value="medicine">Electronics</option>
                        <option value="self-care">Vehicles</option>
                        <option value="machine">Personnel</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            <form action="products.php" method="POST">
                ...
                <div class="input-group mb-3 form-group">
                    ...
                    <select name="cat" class="form-select" id="inputGroupSelect01">
                        ...
                        <option value="medicine">Electronics</option>
                        <option value="self-care">Vehicle</option>
                        <option value="machine">Personnel</option>
                    </select>
                </div>
                <div class="form-group">

    ...
    <div class="container-fluid">
        ...
        ?>
            ...
            <div style="margin-left: 350px; padding-right: 100px;">
                <a href="cart.php?delete_all=1" class="btn btn-outline-danger btn-lg"> Clear The Cart !</a>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        ?>
            ...
            <p style="text-align: center; font-family: 'Fredoka One', cursive;">Please add at least product to the cart</p>
